...
@section('title-section', 'Editar Paciente')

@section('content')
<div class="container my-4">
    <form action="{{ route('odontologo.pacientes.update', $paciente->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
                ...
                <div class="card shadow-sm card-hover" style="border-left:5px solid #36808B;">
                    <div class="card-body">
                        ...
                        <div style="margin-top:10px;">
                            <img id="foto-preview" 
                                 src="{{ $paciente->foto ? asset('storage/'.$paciente->foto) : asset('img/default-avatar.png') }}" 
                                 alt="" 
